...
public class AIPromptGenerator {
    ...
    private static final String STREAMING_PROMPT_TEMPLATE = """
            ...
            ## 매우 중요: 작성금지단어
            입력된 정보를 바탕으로 생활기록부를 작성할 때, 아래 사항들은 절대 작성하지 마세요.
            - 회사명, 상호명, 브랜드명, 서비스명, 사이트명을 포함하지 마세요.
            - 공익어학 시험 자격증명은 작성 불가능
            - 교외 및 교내 대회 수상 경력은 기재할 수 없음
            - 구체적인 특정 대학명, 기관명은 입력할 수 없음
            - 영어는 반드시 한글 단어로 대체하여 작성하고 신조어는 사용하지 말아주세요.
            - 학생의 점수와 평가는 입력하지 마세요.
    ...
    public static String createStreamingPrompt(final StudentRecordType recordType, final int byteCount, final String inputPrompt) {
