...
public class AIPromptGenerator {
    ...
    private static final String STREAMING_PROMPT_TEMPLATE = """
            ...
            부정적인 내용이 있다면, 긍정적인 개선 방향이나 배운 점으로 재해석하여 서술해주세요. 단, '~할 계획임'과 같이 추측성 표현이나 학생 활동 내용에 존재하지 않는 내용은 작성하지 마세요.
            
            지금은 바이트 수나 '음슴체', 금지 단어 같은 세세한 규칙은 신경 쓰지 말고 내용의 풍부함과 창의성에만 집중해 총 3가지 버전을 작성해주세요.
            각 버전은 응답 형식을 참고하여 명확히 구분해주세요.
