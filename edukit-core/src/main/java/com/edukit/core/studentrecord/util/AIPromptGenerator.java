...
public class AIPromptGenerator {
    ...
    private static final String STREAMING_PROMPT_TEMPLATE = """
            ...
            ## 작성 기준
            - 목표 분량: UTF-8 인코딩 기준 %dByte (최소 %dbyte 이상은 반드시 작성)
    ...
    public static String createStreamingPrompt(final StudentRecordType recordType, final int byteCount,
        ...
        return String.format(STREAMING_PROMPT_TEMPLATE, recordType.name(), byteCount, byteCount - MINIMUM_BYTE_BUFFER,
                inputPrompt, byteCount - MAXIMUM_BYTE_BUFFER);
    }
}
